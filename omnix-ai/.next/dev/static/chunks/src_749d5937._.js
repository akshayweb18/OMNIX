...
_s(ChatHeader, "wIUbXz7m8S0H8X1HSFh6+xIruHs=");
_c = ChatHeader;
var _c;
...
function useSpeech() {
    ...
    const speak = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useSpeech.useCallback[speak]": (text, forcedLang = null)=>{
            if (!text) return;
            // Clean text to avoid speaking unnecessary filler words
            const sanitizeForSpeech = {
                "useSpeech.useCallback[speak].sanitizeForSpeech": (raw)=>{
                    if (!raw) return raw;
                    let s = String(raw);
            ...
            }["useSpeech.useCallback[speak].sanitizeForSpeech"];
            ...
            utterance.volume = 1;
            utterance.onstart = ({
                "useSpeech.useCallback[speak]": ()=>setSpeaking(true)
            })["useSpeech.useCallback[speak]"];
            utterance.onend = ({
                "useSpeech.useCallback[speak]": ()=>setSpeaking(false)
            })["useSpeech.useCallback[speak]"];
...
_s(useSpeech, "Fm1Y/BQ7q9IOO7GcdoC/nNzEVB0=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
_s(useChat, "hq4AwCU/cjqbSZgH8tz5GrloLy8=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
function ChatLayout() {
    _s();
    const { messages, sendMessage, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useChat$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useChat"])();
...
_s(ChatLayout, "/O8nKhtFhBWzmx9Pve6oolLfsXo=", false, function() {
    return [
...
//# sourceMappingURL=src_749d5937._.js.map