...
export default function ChatHeader({ onMenuToggle, onNewChat, isMuted, onToggleMute }) {
    ...
    <>
      <header style={{
        ...
        <div style={{ position: "relative", zIndex: 110, display: "flex", alignItems: "center", gap: 8, flexShrink: 0 }}>
          ...
          {/* Mute Toggle */}
          <button onClick={onToggleMute} className="header-btn header-btn-subtle" style={{ width: 36, height: 36, color: isMuted ? "#f87171" : "var(--t3)" }} title={isMuted ? "Unmute AI" : "Mute AI"}>
            {isMuted ? (
              <svg style={{ width: 16, height: 16 }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 9.75L19.5 12m0 0l2.25 2.25M19.5 12l2.25-2.25M19.5 12l-2.25 2.25m-10.5-6.75h-2.25a.75.75 0 00-.75.75v6.75a.75.75 0 00.75.75h2.25l5.25 3.75V3.75l-5.25 3.75z" />
              </svg>
            ) : (
              <svg style={{ width: 16, height: 16 }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
